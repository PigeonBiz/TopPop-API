...
def yt_search_api_path(search, config, result_num)
...
search_url = yt_search_api_path(SEARCH_KEY_WORD, config, SEARCH_RESULT_NUM)
...
# BAD search request
bad_search_url = yt_search_api_path(SEARCH_KEY_WORD, 'bad_token', SEARCH_RESULT_NUM)
